...
export default function PricingCalculator({
  ...
  useEffect(() => {
    if (exchangeRateData) {
      ...
      const usdCurrency = exchangeRateData.currencies.find(
        (c) => c.code === "USD",
      );
      if (usdCurrency) {
    ...
    <div className="container mx-auto px-4 py-8 space-y-6">
      <div className="text-center space-y-2 max-w-2xl mx-auto">
        ...
        <p className="text-sm text-gray-600 dark:text-zinc-400 max-w-md mx-auto">
          💡 These are estimates updated daily at midnight UTC. The most
          accurate results will be displayed while making payment.
        </p>
      </div>
