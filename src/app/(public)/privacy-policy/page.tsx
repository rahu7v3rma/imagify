      ...
      <div className="max-w-3xl mx-auto space-y-6 text-[15px] py-10">
        ...
        <List
          ...
          options={[
            ...
            <>
              User-generated content &mdash; Only images (uploaded or generated)
              are temporarily stored so you can download your results. Links,
              prompts, and text are never stored on our servers. All images are
            ...
            <>
              Payment information &mdash; handled directly by our secure payment
              processors. We do not store your payment details on our servers.
            </>,
          ]}
        />
        ...
        <P>
          ...
          us at <Link href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</Link>.
        </P>
      </div>
    </div>
  );
