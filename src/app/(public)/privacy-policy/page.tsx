    ...
    <div className="h-full w-full">
      ...
      <div className="max-w-3xl mx-auto space-y-6 text-[15px] py-10">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            <strong>User-generated content</strong> &mdash; Only images
            (uploaded or generated) are temporarily stored so you can download
            your results. Links, prompts, and text are never stored on our
            servers. All images are automatically deleted daily at midnight UTC.
          </li>
          <li>
            <strong>Usage information</strong> such as remaining
            processing&nbsp;
