          ...
          <div className="flex-1">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Advanced algorithms detect and remove backgrounds automatically</p>
              </div>
              
              <div>
                <h4 className="font-medium text-base">Two Processing Modes</h4>
                <p className="text-sm text-muted-foreground">Fast mode for quick results, Standard for higher quality</p>
              </div>
              
              <div>
                <h4 className="font-medium text-base">Multiple Upload Options</h4>
                <p className="text-sm text-muted-foreground">Upload files directly or provide image URLs</p>
              </div>
              
              <div>
                <h4 className="font-medium text-base">Instant Download</h4>
                <p className="text-sm text-muted-foreground">Get transparent PNG files ready for use</p>
              </div>
            </div>
          </div>
