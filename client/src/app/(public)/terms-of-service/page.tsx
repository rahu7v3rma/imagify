...
export default function TermsOfServicePage() {
  return (
    <div className="max-w-3xl mx-auto space-y-6 text-gray-800 dark:text-zinc-200">
      ...
      <p>
        We do not use, analyze, or derive any commercial value from your uploaded
        content beyond providing the specific image processing services you request.
        All images you upload are stored temporarily on our servers solely for the
        purpose of processing and delivering the requested transformations.
      </p>
      <p>
        For security and privacy protection, all stored images and associated data
        are automatically deleted from our servers daily at midnight UTC. We do not
        retain copies of your images beyond this processing period, and we do not
